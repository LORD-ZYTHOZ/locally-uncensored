...
export function getMainstreamTextModels(): DiscoverModel[] {
  return sortByRelease([
    ...
    // ── GLM 5.1 (April 2026) ──
    { name: 'GLM 5.1 754B MoE', description: 'ZhipuAI GLM 5.1 — 754B MoE (40B active). Frontier agentic engineering model. MIT license. Needs multi-file download via CLI.', pulls: '50K+', tags: ['754B MoE', 'IQ2_M', '236 GB'], updated: 'Hot', hot: true, agent: true, released: '2026-04', url: 'https://huggingface.co/unsloth/GLM-5.1-GGUF', canPull: false, sizeGB: 236 },
